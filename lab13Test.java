...
public class lab13Test {
	...
	public void setUp() throws Exception {
		...
		try {
			...
			// so that you can use "assertArrayEquals" to verify expectedResult1 and
			// lab.getResult1() are the same
			...
			// so that you can use "assertArrayEquals" to verify expectedResult2 and
			// lab.getResult2() are the same
			...
			// so that you can use "assertArrayEquals" to verify expectedResult3 and
			// lab.getResult3() are the same
